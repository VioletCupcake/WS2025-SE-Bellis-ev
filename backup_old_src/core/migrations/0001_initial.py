# Generated by Django 5.0.1 on 2026-01-03 16:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('BASIS', 'Basis'), ('ERWEITERT', 'Erweitert'), ('ADMIN', 'Administrator')], max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            name='PermissionSet',
            fields=[
                ('permission_set_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='users', to='core.role')),
            ],
            options={
